...
robotics-lab/
  apps/
    ...
    slam-demo/          visual SLAM explorer (authored lab and local sparse mapping)
  packages/
    core/               shared types
...
Phase 4 adds image-derived stereo visual odometry, feature overlays and honest tracking-loss states. Phase 5 adds persistent local mapping, bundle adjustment and selectable reconstruction. Loop closure and relocalization remain planned.
...
- **Visual SLAM Demo** — Phases 1–5 implemented (motion, authored lab, stereo acquisition, visual odometry and local mapping);
  [loop closure and relocalization planned](./docs/slam-demo.md)
